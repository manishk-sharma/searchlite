...
import { VerticalTimeline } from './Home'
import './About.css'
import './Home.css'
...
const milestones = [
  { year: '2021', title: 'Building Trust', desc: 'Launched operations with a single team member dedicated to serving one specific client.' },
  { year: '2022', title: 'Scalability', desc: 'Expanded capabilities by collaborating with dependable freelancers.' },
  { year: '2023', title: 'Diversification', desc: 'Acquired multiple clients and leveraged AI to enhance workflow efficiency and accelerate execution.' },
  { year: '2024', title: 'Strategic Growth', desc: 'Experienced substantial growth with internal team members and formed a solid organizational structure.' },
]
